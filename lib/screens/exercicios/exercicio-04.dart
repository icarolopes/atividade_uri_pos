...
class Exercicio04 extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => Exercicio04State();

}
class Exercicio04State extends State {
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: RaisedButton(
                    ...
                    onPressed: () async {
                      try {
                        final String result = await platform.invokeMethod("exercicio04", { 'numero':  numeroController.text });
